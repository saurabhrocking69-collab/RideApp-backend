...
// ─── Mask real phone for other party — display only ───
...
// ══════════════════════════════════════════════════
//  MASKED CALLING — Proxy calls via Exotel (TRAI-compliant)
//  Real phone numbers are NEVER sent to either party's app.
//  Exotel initiates a bridge call: customer ↔ virtual number ↔ driver
//  Fallback: direct call when Exotel env vars not configured
// ══════════════════════════════════════════════════
app.post('/api/call/initiate', async (req, res) => {
  ...
  try {
    ...
    // Exotel masked call (when configured via env vars)
    ...
    // Fallback: return real number for direct call (remove once Exotel is live)
